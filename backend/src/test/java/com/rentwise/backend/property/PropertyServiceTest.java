...
public class PropertyServiceTest {
    ...
    @Test
    void testCreateProperty_InvalidCityForState() {
        PropertyOnboardingCommand command = new PropertyOnboardingCommand(
                "Invalid Location Apartment",
                "Apartment",
                "123 Main St",
                "Indiranagar",
                "Mumbai",
        ...
        IllegalArgumentException exception = assertThrows(
                ...
                () -> propertyService.createProperty(command, testCreator)
        );
    ...
    void testSearchProperties_ByCity() {
        ...
        var results = propertyService.searchProperties("Mumbai");
